 ...
 */
@Provider
public class NoRecordFoundExceptionMapper implements ExceptionMapper<CoudNotCreateRecordException>{

    public Response toResponse(CoudNotCreateRecordException exception) {
        ErrorMessage errorMessage = new ErrorMessage(
                exception.getMessage(), ErrorMessages.NO_RECORD_FOUND.name(),"http://google.com.br" );
